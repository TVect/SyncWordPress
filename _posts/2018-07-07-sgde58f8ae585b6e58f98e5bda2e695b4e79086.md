...
post_excerpt: ""
layout: post
permalink: 'http://blog.tvect.cc/2018/07/07/sgd%e5%8f%8a%e5%85%b6%e5%8f%98%e5%bd%a2%e6%95%b4%e7%90%86/'
published: true
...
直观上，Adagrad 尝试给二阶导数大的参数(或者是更新次数多的参数)更小的学习率。因为二阶导数大可能会比二阶导数小的变量离极小点更近。<del>这里用一阶导数的平方和来近似估计二阶导数</del>
